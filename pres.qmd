...
## [Arquitectura de Monitoreo | Model monitoring | Revisión]{.big-par}

::: {.incremental .medium-par}
- **Cómo planeamos estimar la validez de las métricas que calculamos?**
  - Seleccionamos un subconjunto de registros para un periodo determinado (ej: coyuntura) para ser revisado por analistas expertos...
  - Criterios utilizados en la selección:
    - Debe contener registros observados en los valores más altos y más bajos del **revision_score**, ordenados aleatoriamente.
    - Distribución de clases...como en dataset de producción analizado...
  - Colaboración de analistas:
    - Dos analistas clasificarán el mismo subconjunto de registros seleccionados.
      - Esto permite contar con una clasificación independiente...
    - Los analistas además responderán un par de preguntas que nos permitirán evaluar la **complejidad** y **novedad** de los registros seleccionados, a partir de conocimiento experto.
  - Siguientes pasos:
    - Tras la revisión, analizaremos ... entre clasificación, complejidad y novedad asignadas por analistas y nuestras métricas... 
    - Si tras el análisis, concluimos que nuestras métricas tienen validez, podemos evaluar el cambio en la performance del modelo incluyendo las mismas muestras seleccionadas en el entrenamiento para decidir si es conveniente realizar un re-entrenamiento del mismo...  
:::
