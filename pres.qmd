...
::: {.incremental .medium-par}
- **Comparamos los dataset de producción (coyuntura) y de referencia (entrenamiento)**, aplicando varios tests y reports implementados por la librería open-source [Evidently](https://docs-old.evidentlyai.com/).
:::
...
| Test / Report                      | Evaluación | Nivel <br> clase / dataset |
|:-----------------------------------|:------------|:------------|
...
::: {.incremental .medium-par}
- **2) Kolmogorov–Smirnov (K-S) test**: returns *p_value*... 
  - *drift_score* en rango ...:
    - *< threshold* es indicativo de drift. Por defecto *threshold = 0.05* 
:::
