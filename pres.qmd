...
- Solución: **monitoreo periódico y re-entrenamiento de los modelos**.
  ...
  - Con esos datos implementamos el monitoreo: **comparando el nuevo dataset mensual (producción) versus el que fue usado para entrenar los modelos (referencia)**, evaluando la existencia de **data drift**. 
:::
...
- **Deriva de covariables** (*Covariate drift*): Ocurre cuando la distribución de las variables de entrada cambia, pero la relación entre estas características y la variable objetivo se mantiene igual.
  - Cambia la forma en que se describen ocupaciones/actividades, pero el significado final (la etiqueta) sigue igual.
...
- **Cómo validamos las métricas que calculamos?**
  - Colaboración de analistas:
    ...
    - Podemos compartir los registros seleccionados junto a las preguntas extra en un [formato familiar](https://nomenclatura-dev.ine.cl/) para analistas.
:::
