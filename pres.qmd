...
- Además de la ENE, otras instituciones públicas también usan estos modelos (MDSF, ChileCompras, DT, FNE).
:::
...
::: {.incremental .medium-par}
- **3) Binary Classifier** usado para distinguir entre los embeddings calculados desde ambos datasets.
...
![](imagenes/monitoring/jensen_shannon_distance_estimation_01.png){.fragment width="100%"}

:::

::: {.r-stack fragment-index=2 .center}

![](imagenes/monitoring/jensen_shannon_distance_estimation_02.png){.fragment width="90%"}
